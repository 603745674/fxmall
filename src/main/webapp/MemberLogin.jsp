                ...
                <form  method="post" action="userlogin">
                    <div class="login-title text-center">
                        ...
                        <div>
                            ...
                            <input type="radio" name="user_ck" onclick="clickRadio(1);" id="customer" checked="true" value="1">商户登录
                        </div>
...
<script type="text/javascript">
    function login() {
        ...
        $.post("WxbMemeberlogin",{name:usernameStr,password:passwordStr},function(data){
            if (data.code == 1) {
                //登录成功
                window.location.href="goods.do?m=AllGoods";
            } else {
                alert("登录失败："+data.msg);
            }
        });
