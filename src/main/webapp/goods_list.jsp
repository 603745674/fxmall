                                            ...
                                            <div class="dataTables_paginate paging_bootstrap sender">
                                                <ul class="pagination">
                                                   <%-- <li><a href="goods.do?page=" class="active">上一页</a></li>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${page>1}">
                                                       <li><a href="goods.do?m=login&page=${page-1}">上一页</a></li>
                                                        </c:when>
                                                        <c:otherwise>
                                                       <li><a href="goods.do?m=login&page=${page}">上一页</a></li>
                                                        </c:otherwise>
                                                    </c:choose>
                                                    <!-- 绘制分页标签 -->
                                                    <c:forEach var="i" begin="1" end="${pages}">
                                                       <li><a href="goods.do?m=login&page=${i}">${i}</a></li>
                                                    </c:forEach>
                                                    <!-- 判断是否使用下一页连接 -->
                                                    <c:choose>
                                                        <c:when test="${page<pages}">
                                                       <li><a href="goods.do?m=login&page=${page+1}">下一页</a></li>
                                                        </c:when>
                                                        <c:otherwise>
                                                       <li><a href="goods.do?m=login&page=${page}">下一页</a></li>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </ul>
                                            </div>
